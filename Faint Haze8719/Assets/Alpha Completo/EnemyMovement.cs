    ...
    protected override void ComputeVelocity()
    {
        switch (ActiveStatus)
        {
            case Status.Ronda:                         //Status di movimento base, Comincia in questo status
                ...
                {
                    if(player.stealth_status==Haze.Visibility.Visible || player.stealth_status == Haze.Visibility.Caution && !(player.isDead))
                    {

                        SoundManagerScript.PlaySound("AttaccoNemico");
                        player.Death();
                    }
                }
                break;
            ...
            case Status.Attratto:                                               //Stauts che comincia quando il nemico entra nel Collider Esterno dei feromoni(In questo Stato il raycast per il cono di visione non è presente)
                ...
                //SoundManagerScript.PlaySound("FeromoniIntNemici");
